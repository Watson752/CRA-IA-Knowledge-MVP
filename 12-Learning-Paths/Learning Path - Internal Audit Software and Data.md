---
title: Learning Path - Internal Audit Software and Data
aliases:
  - IA software and data path
  - Internal Audit Software and Data onboarding
...
**Derived onboarding path** for someone working in Internal Audit with a software and data background. Not an official CRA curriculum.

Branch mandates and case roles come from official public sources; the **order** is a vault teaching aid. See [[Ownership and Assurance Roles]] and [[Organizational-Onboarding-Path]].
...
→ SIIB
→ Security Branch
→ Engagement-relevant program branch
→ DTPB
→ BI case (capstone)
→ Cyber or EFMS (optional)
```
...
- Do not invent ITB MAP ownership on the cyber case (protected content).
