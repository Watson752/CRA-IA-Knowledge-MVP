...
source_url: "https://www.canada.ca/en/revenue-agency/corporate/about-canada-revenue-agency-cra/ministerial-transition-2025/organization.html"
...
```text
Acronym in this table
→ Canonical note (wikilink)
→ Branch mandate / classification
→ [[Ownership and Assurance Roles]] / related concepts
→ [[Public-Audit-Case-Map]]
→ Official SRC note (e.g. [[99-Sources/source-notes/SRC-CRA-Org-2025]])
```

Prefer `02-Organization/Branches/` notes. Legacy `01-Organization/* (legacy redirect)` files do not carry branch acronym aliases.

## Acronym verification rule

Acronyms are added as aliases only when an official CRA public source (organization page, published audit/evaluation, departmental results material, or similarly authoritative canada.ca page) uses or clearly establishes them. Do not invent acronyms from name initials alone.

Only acronyms supported by official public CRA/Government of Canada sources or existing vault case notes grounded in those sources. Status markers:

- **Status: current** — used in current official public materials
- **Status: historical** — appears in older public materials; not treated as current structure
- **Status: verification required** — seen in vault/report language but needs cautious use
...
| Acronym | Full form | Type | Plain-language purpose | Status | Canonical note |
|---|---|---|---|---|---|
| TSO | Tax Services Office | Regional office type | Complex audit/collection files | current | [[CRA-Regions]] |
| TC | Tax Centre | Regional office type | Tax return processing | current | [[CRA-Regions]] |
| NVCC | National Verification and Collections Centre | Regional office type | Non-complex collections/validation/verification | current | [[CRA-Regions]] |
| CC | Contact Centre | Regional office type | Tax and benefits enquiries | current | [[CRA-Regions]] |
| NSC | Northern Service Centre | Regional office type | Support in northern territories | current | [[CRA-Regions]] |
| COE | Centre of Expertise | Regional/functional unit type | Focus-area leadership and support | current | [[CRA-Regions]] |
| OLO | Ombudsperson Liaison Office | Headquarters liaison office | CRA point of contact for OTO service issues; located in SIIB | current | [[Service, Innovation, and Integration Branch]] |
| OTO | Office of the Taxpayers’ Ombudsperson | External arm’s-length office | Service complaints and systemic service reviews | current | [[Taxpayers Ombudsperson]] |

## Executive roles

| Acronym | Full form | Type | Plain-language purpose | Status | Canonical note |
|---|---|---|---|---|---|
| AC | Assistant Commissioner | Executive role | Leads a headquarters branch | current | [[Assistant Commissioner]] |
| DAC | Deputy Assistant Commissioner | Executive role | Deputy branch executive where named | current | [[Deputy Assistant Commissioner]] |
| RAC | Regional Assistant Commissioner | Executive role | Leads a region | current | [[Regional Assistant Commissioner]] |
| a/RAC | Acting Regional Assistant Commissioner | Executive role | Temporary RAC appointment | current | [[Regional Assistant Commissioner]] |
| ADM | Assistant Deputy Minister | Executive role | Used publicly for Justice Tax Law Services leadership of Legal Services | current | [[Legal Services Branch]] |
...
| Acronym | Full form | Type | Plain-language purpose | Status | Canonical note |
|---|---|---|---|---|---|
| IA | Internal Audit | Assurance function | Independent assurance engagements | current | [[Internal Audit and Program Evaluation]] |
| PE | Program Evaluation | Evaluation function | Assesses program/policy results | current | [[Internal Audit and Program Evaluation]] |
| IA/PE | Internal Audit and Program Evaluation | Combined public label | Public landing page for published reports | current | [[Internal Audit and Program Evaluation]] |
| ERM | Enterprise Risk Management | Risk function | Holistic risk management approach | current | [[Risk Management]] |
| ERMD | Enterprise Risk Management Division | Organizational unit | AERB unit named in public financial discussion | current | [[Audit, Evaluation, and Risk Branch]] |
| MAP | Management Action Plan | Audit response | Management commitments to address recommendations | current | [[Management Action Plan]] |
| OPI | Office of Primary Interest | Audit role | Business area primarily responsible for audited subject | current | [[Scope]] |
| BOM | Board of Management | Governance body | Oversees CRA organization/administration | current | [[Board of Management]] |
| GIC | Governor in Council | Appointment authority | Appoints Board directors and related offices | current | [[Board of Management]] |
| CPI | Corporate Policy Instrument | Governance artifact | Corporate policies overseen with Corporate Secretariat support | current | [[Corporate Secretariat]] |
| BIDGSC | Business Intelligence Director General Steering Committee | Governance forum | BI oversight forum co-chaired by SIIB and ITB (BI audit) | current | [[Business Intelligence Governance]] |

## Tax and benefit programs

| Acronym | Full form | Type | Plain-language purpose | Status | Canonical note |
|---|---|---|---|---|---|
| ARNI | Accounts Receivable National Inventory | Collections program | Risk-scored collections inventory below $1M threshold (public audit) | current | [[Internal Audit - Accounts Receivable National Inventory]] |
| CCB | Canada Child Benefit | Benefit program | Federal child benefit administered with CRA involvement | current | [[Benefits Administration]] |
| GST/HST | Goods and Services Tax / Harmonized Sales Tax | Tax | Sales tax administration themes | current | [[Tax Administration]] |
| T1 / T2 / T3 | Income tax return types | Tax filing | Individual / corporate / trust return contexts in public stats and evaluations | current | [[Initial Assessment Data]] |
| CEBA | Canada Emergency Business Account | Historical program | Pandemic support program referenced in public audit context | historical | [[Tax Administration]] |
...
- Do not silently treat historical branch names as current.
- Prefer full branch titles in prose; use acronyms after first introduction.
- Prefer role notes over person-centric notes for the knowledge graph.

## Sources

- [Organization — Ministerial Transition 2025](https://www.canada.ca/en/revenue-agency/corporate/about-canada-revenue-agency-cra/ministerial-transition-2025/organization.html)
- Published CRA internal audit/evaluation reports indexed in [[Public-Audit-Case-Library]]
